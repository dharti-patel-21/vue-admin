...
const getAppointmentCount = () => {
    axios.get('/api/stats/appointment', {
        params: {
                    ...
                    <div class="small-box bg-info">
                        <div class="inner">
                            <div class="d-flex justify-content-between">
                                ...
                                <select v-model="selectedAppointmentStatus" @change="getAppointmentCount()" style="height: 2rem; outline: 2px solid transparent;" class="px-1 rounded border-0">
