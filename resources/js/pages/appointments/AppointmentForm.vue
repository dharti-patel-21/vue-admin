                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input v-model="form.title" type="text" :class="{'is-invalide':errors.title}" class="form-control" id="title" placeholder="Enter Title">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select v-model="form.client_id" :class="{'is-invalide':errors.client_id}" id="client" class="form-control">
